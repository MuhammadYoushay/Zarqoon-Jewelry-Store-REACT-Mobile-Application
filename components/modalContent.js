...
const ModalContent = ({ product, addToCart, closeModal }) => (
  <View style={styles.modalContent}>
    <Image style={styles.modalImage} source={{ uri: product.image }} />
    <Text style={styles.modalProductName}>{product.name}</Text>
    <Text style={styles.modalProductPrice}>Rs. {product.price}</Text>
    <Text style={styles.modalProductDesc}>{product.description}</Text>
    <TouchableOpacity style={styles.addToCartButton} onPress={addToCart}>
      <Text style={styles.addToCartButtonText}>Add to Cart</Text>
    </TouchableOpacity>
    <TouchableOpacity style={styles.closeButton} onPress={closeModal}>
      <Text style={styles.closeButtonT}>CLOSE</Text>
    </TouchableOpacity>
  </View>
);
